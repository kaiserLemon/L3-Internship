...
N = 64   #number of vertices in the graph. Only used in the reward function, not directly relevant to the algorithm 
...
def calcScore(state):
	...
	evals = np.linalg.eigvalsh(adjMatG)
	...
	if myScore > -0.08:
		...
		print("valeur de lambda1: " + str(lambda1) +  "\n valeur de proximity: " + str(proximity) + "\n valeur de diam: " + str(diam))
		exit()
