...
N = 43   #number of vertices in the graph. Only used in the reward function, not directly relevant to the algorithm 
...
def calcScore(state):
	...
	#myScore = math.sqrt(N-1) - lambda1 * mu
	myScore = lambda1 - mu - (N-1-math.floor(N/2))
	if myScore > 0:
		#You have found a counterexample. Do something with it.
		print(nx.to_prufer_sequence(G))
		print(time.time()-start_time)
		print("valeur de lambda1: " + str(lambda1) +  "\n valeur de mu: " + str(mu))
